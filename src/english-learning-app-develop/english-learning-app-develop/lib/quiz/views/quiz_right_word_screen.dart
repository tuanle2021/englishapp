...
class QuizRightWordScreen extends StatefulWidget {
  ...
  @override
  State<QuizRightWordScreen> createState() => _QuizRightWordScreenState();
}

class _QuizRightWordScreenState extends State<QuizRightWordScreen> {
    ...
    if (word != null) {
      return Container(
          ...
          child: Column(children: [
            ...
            Text(AppLocalizations.of(context).chooseRightChoice,
            ...
            Text(
              AppLocalizations.of(context).whichWordMean,
              style: Theme.of(context)
                  .textTheme
                  .titleLarge!
                  .copyWith(fontWeight: FontWeight.bold),
